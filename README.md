...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>spinach/README.md at master · scottmetoyer/spinach</title>
...
<meta content="L5Gt6Dbc1P1b4P1ASfz8m9XWoWWrMRadcJPkiHHX14k=" name="csrf-token" />
  ...
  <link href="https://github.com/scottmetoyer/spinach/commits/master.atom" rel="alternate" title="Recent Commits to spinach:master" type="application/atom+xml" />
  ...
  <input type="text" name="q" id="command-bar" placeholder="Search or type a command" tabindex="1" data-username="scottmetoyer" autocapitalize="off">
  ...
  <ul class="tabs">
    <li><a href="/scottmetoyer/spinach" class="selected" highlight="repo_sourcerepo_downloadsrepo_commitsrepo_tagsrepo_branches">Code</a></li>
    <li><a href="/scottmetoyer/spinach/network" highlight="repo_network">Network</a></li>
    <li><a href="/scottmetoyer/spinach/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>0</span></a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/scottmetoyer/spinach/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter blank">0</span></a></li>
    </ul>
  ...
  <ul class="tabnav-tabs">
    <li><a href="/scottmetoyer/spinach" class="selected tabnav-tab" highlight="repo_source">Files</a></li>
    <li><a href="/scottmetoyer/spinach/commits/master" class="tabnav-tab" highlight="repo_commits">Commits</a></li>
    <li><a href="/scottmetoyer/spinach/branches" class="tabnav-tab" highlight="repo_branches" rel="nofollow">Branches <span class="counter ">1</span></a></li>
  </ul>
...
<!-- blob contrib key: blob_contributors:v21:273ba7bbcb9474393f4c489335c6447d -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:273ba7bbcb9474393f4c489335c6447d -->
...
<a name="spinach" class="anchor" href="#spinach"><span class="mini-icon mini-icon-link"></span></a>spinach</h1>

<p>Freeform granular synthesizer</p></article>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.09511s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
